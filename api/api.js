...
export const getCodeApi = (responseType) => getAction('https://jxfw.gdut.edu.cn/yzm?d=1603814815275', {}, {}, responseType)
export const loginApi = (options) => postAction('/login/wxMiniProGramLogin', options)
...
export const cancelOrderApi = (orderId, header) => putAction(`/api/order/cancelByEr/${orderId}`, header)
